...
function numeroMasGrande(numeros) {
  ...
  for (let index = 0; index < numeros.length; index++) {if (numeros[i] > largo) {
    largo = numeros[i]}}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  if (numeroDeDia === 6 || numeroDeDia === 7) {return "Es fin de semana"}
...
function mesesDelAño(array) {
  ...
  let mesesEncontrados = array.filter(array => mesesBuscados.includes(array));
  
  if (mesesBuscados.length === mesesEncontrados.length) {return mesesBuscados}
